  ...
  return (
    <>
      ...
      <Countdown
        ...
        renderer={props => 
          <span className="countdown font-mono text-4xl">
            <span id="countdownElement" style={{"--value": props.seconds} as React.CSSProperties}></span>
          </span>
        }
      ...
      <div>
        ...
        <button className="btn btn-square" onClick={handleNext}>
